    ...
    <div class="row chat-row">
        ...
        <div class="col-md-9 chat-section">
            <div class="chat-header">
                ...
                <div class="chat-name" style="font-weight: bold">
                    {{$friendInfo->name}}
                </div>
            </div>
            ...
            <div class="chat-box">
                ...
                <div class="chat-input-toolbar">
                    <button title="Добавить файл" class="btn btn-light btn-sm btn-file-upload">
                        <i class="fa fa-paperclip"></i>
                    </button> |
                    <button title="Жирный" class="btn btn-light btn-sm tool-items" onclick="document.execCommand('bold',false, '')">
